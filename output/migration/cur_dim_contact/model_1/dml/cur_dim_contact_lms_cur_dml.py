...
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_LMS PARTITION (['source_key'] = 'LMS')    SELECT
        owner_id
        , contact_owner_type
        , contact_type
        , contact_value
...
spark.sql(f"""
    ANALYZE TABLE {params["cur_schema"]}.DIM_CONTACT_LMS PARTITION (['source_key'] = 'LMS') COMPUTE STATISTICS
""")
