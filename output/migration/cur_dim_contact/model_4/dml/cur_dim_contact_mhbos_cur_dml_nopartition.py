...
spark.sql(f"""
    INSERT INTO TABLE {params["cur_schema"]}.DIM_CONTACT_MHBOS_h PARTITION (['source_key'], hist_year)
    SELECT
        cur.owner_id,
        cur.contact_owner_type,
        cur.contact_type,
...
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_MHBOS PARTITION (['source_key'] = 'MHBOS')    SELECT
        owner_id,
        contact_owner_type,
        contact_type,
        contact_value,
...
spark.sql(f"""
    ANALYZE TABLE {params["cur_schema"]}.DIM_CONTACT_MHBOS PARTITION (['source_key'] = 'MHBOS') COMPUTE STATISTICS
""")
