...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_MHBOS
...
,'MHBOS' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_MHBOS_updated
""")
