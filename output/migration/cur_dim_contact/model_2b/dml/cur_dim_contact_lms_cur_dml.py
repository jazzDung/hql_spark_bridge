...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.DIM_CONTACT_LMS
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_LMS
...
,'LMS' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_LMS_updated
""")
