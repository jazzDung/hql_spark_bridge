...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.DIM_CONTACT_M21
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_M21
...
,'M21' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_M21_updated
""")
