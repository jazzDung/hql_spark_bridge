...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.DIM_CONTACT_RAK
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_RAK
...
,'RAK' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_RAK_updated
""")
