...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.DIM_CONTACT_SBL
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_SBL
...
,'SBL' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_SBL_updated
""")
