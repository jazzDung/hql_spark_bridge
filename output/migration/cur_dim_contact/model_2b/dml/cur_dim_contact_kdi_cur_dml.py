...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.DIM_CONTACT_KDI
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_KDI
...
,'KDI' AS ['source_key']    FROM {params["com_schema"]}.temp_DIM_CONTACT_KDI_updated
""")
