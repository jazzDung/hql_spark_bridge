...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_DIM_CONTACT_GUAVA_delta
    SELECT
        com_t.owner_id,
    ...
    FROM {params["com_schema"]}.DIM_CONTACT_GUAVA com_t
    INNER JOIN (
        SELECT DISTINCT OWNER_ID,CONTACT_OWNER_TYPE,CONTACT_TYPE        FROM {params["com_schema"]}.DIM_CONTACT_GUAVA
