...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_DIM_CONTACT_SBL_delta
    SELECT
        com_t.owner_id,
        ...
        com_t.sequence_no
    FROM {params["com_schema"]}.DIM_CONTACT_SBL com_t
    INNER JOIN (
        SELECT DISTINCT OWNER_ID,CONTACT_OWNER_TYPE,CONTACT_TYPE        FROM {params["com_schema"]}.DIM_CONTACT_SBL
...
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.DIM_CONTACT_SBL PARTITION (['source_key'] = 'SBL')    SELECT
        owner_id,
        contact_owner_type,
        contact_type,
        contact_value,
...
spark.sql(f"""
    ANALYZE TABLE {params["cur_schema"]}.DIM_CONTACT_SBL PARTITION (['source_key'] = 'SBL') COMPUTE STATISTICS
""")
