...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_dim_customer_lms_delta
    SELECT
        com_t.customer_id,
        com_t.customer_type,
    ...
    FROM {params["com_schema"]}.dim_customer_lms com_t
    INNER JOIN (
        SELECT DISTINCT CUSTOMER_ID        FROM {params["com_schema"]}.dim_customer_lms
