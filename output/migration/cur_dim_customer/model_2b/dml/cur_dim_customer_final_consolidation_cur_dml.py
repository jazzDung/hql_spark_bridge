...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_customer_final_consolidation
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_customer_final_consolidation
...
,'FINAL_CONSOLIDATION' AS source_key    FROM {params["com_schema"]}.temp_dim_customer_final_consolidation_updated
""")
