...
spark.sql(f"""DROP TABLE IF EXISTS {params["com_schema"]}.temp_dim_customer_lmskibb2_delta""")
spark.sql(f"""
    CREATE TABLE {params["com_schema"]}.temp_dim_customer_lmskibb2_delta (
...
spark.sql(f"""DROP TABLE IF EXISTS {params["com_schema"]}.temp_dim_customer_lmskibb2_updated""")
spark.sql(f"""
    CREATE TABLE {params["com_schema"]}.temp_dim_customer_lmskibb2_updated (
        snapshot_date DATE,
        customer_id VARCHAR(20),
        customer_type VARCHAR(10),
        customer_title VARCHAR(20),
...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_dim_customer_lmskibb2_updated
    SELECT
        snapshot_date,
        customer_id,
        customer_type,
...
spark.sql(f"""
    ...
    FROM {params["com_schema"]}.temp_dim_customer_lmskibb2_delta delta
""")
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_customer_lmskibb2
...
,'LMSKIBB2' AS source_key    FROM {params["com_schema"]}.temp_dim_customer_lmskibb2_updated
""")

spark.sql(f"""
    ANALYZE TABLE {params["cur_schema"]}.dim_customer_lmskibb2 COMPUTE STATISTICS
""")
