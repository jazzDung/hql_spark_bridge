...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_customer_unknown_source
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_customer_unknown_source
...
,'UNKNOWN_SOURCE' AS source_key    FROM {params["com_schema"]}.temp_dim_customer_unknown_source_updated
""")
