/* ==============[Group.4 - M21: ALGO DB ]============== */
DROP TABLE IF EXISTS ${cur_schema}.TEMP_DIM_CUSTOMER_M21;

CREATE TABLE ${cur_schema}.TEMP_DIM_CUSTOMER_M21 (
...
INSERT INTO ${cur_schema}.TEMP_DIM_CUSTOMER_M21 (
  CUSTOMER_ID, /* None */
  CUSTOMER_TYPE, /* None */
  CUSTOMER_TITLE, /* None */
  CUSTOMER_NAME, /* None */
...
LEFT JOIN (
  ...
  FROM ${cur_schema}.DIM_DECLARATION
  WHERE
...
LEFT JOIN (
  SELECT DISTINCT
    CUSTOMER_ID
  FROM ${cur_schema}.DIM_CRS
  WHERE
    ETL_DT = '${batch_date}' AND SOURCE_NAME = 'M21'
) AS T5 /* None */
  ON T1.CUST_ID = T5.CUSTOMER_ID
LEFT JOIN ${com_schema}.T_M21_STATEMENTRECIPIENT AS T6
  ON T6.CODE = T1.CODE AND T6.ETL_DT = '${batch_date}'
WHERE
  T1.ETL_DT = '${batch_date}' AND NOT T1.CLEAN_RULE_FLAG LIKE '%1%';

/* ==============[Group.5 - M21: ALGO File ]============== */
DROP TABLE IF EXISTS ${cur_schema}.TEMP_DIM_CUSTOMER_M21_A;

CREATE TABLE ${cur_schema}.TEMP_DIM_CUSTOMER_M21_A (
  CUSTOMER_ID VARCHAR(20), /* None */
  CUSTOMER_TYPE VARCHAR(10), /* None */
  CUSTOMER_TITLE VARCHAR(20), /* None */
  CUSTOMER_NAME VARCHAR(250), /* None */
...
INSERT INTO ${cur_schema}.TEMP_DIM_CUSTOMER_M21_A (
  CUSTOMER_ID, /* None */
  CUSTOMER_TYPE, /* None */
  CUSTOMER_TITLE, /* None */
  CUSTOMER_NAME, /* None */
...
SELECT
  ...
  NULL AS VULNERABLE_FLAG
FROM ${com_schema}.M_M21_A_CUSTOMER AS T1 /* None */
LEFT JOIN (
  SELECT DISTINCT
    COUNTRY_CODE_CCRIS,
...
DROP TABLE IF EXISTS ${cur_schema}.TEMP_DIM_CUSTOMER_M21_O;

CREATE TABLE ${cur_schema}.TEMP_DIM_CUSTOMER_M21_O (
  CUSTOMER_ID VARCHAR(20), /* None */
  CUSTOMER_TYPE VARCHAR(10), /* None */
  CUSTOMER_TITLE VARCHAR(20), /* None */
  CUSTOMER_NAME VARCHAR(250), /* None */
...
INSERT INTO ${cur_schema}.TEMP_DIM_CUSTOMER_M21_O (
  CUSTOMER_ID, /* None */
  CUSTOMER_TYPE, /* None */
  CUSTOMER_TITLE, /* None */
  CUSTOMER_NAME, /* None */
...
SELECT
  ...
  COALESCE(T2.COUNTRY_CODE_CCRIS, T1.CUSTOMER_COMPANY_PLACE_OF_BUSINESS) AS CUSTOMER_COMPANY_COUNTRY_OF_BUSINESS,
  NULL AS VULNERABLE_FLAG
FROM ${com_schema}.M_M21_O_CUSTOMER AS T1 /* None */
LEFT JOIN (
  SELECT DISTINCT
    COUNTRY_CODE_3_DIGITS,
    COUNTRY_CODE_CCRIS
