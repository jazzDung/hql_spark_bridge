...
spark.sql(f"""
    ...
    FROM {params["com_schema"]}.temp_dim_customer_unknown_source_delta delta
...
spark.sql(f"""
    INSERT INTO TABLE {params["cur_schema"]}.dim_customer_unknown_source_h PARTITION (source_key, <<partition_column>>, hist_year)
    SELECT
        cur.customer_id,
        cur.customer_type,
        cur.customer_title,
