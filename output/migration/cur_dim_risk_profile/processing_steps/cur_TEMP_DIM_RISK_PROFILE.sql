...
DROP TABLE IF EXISTS ${cur_schema}.TEMP_DIM_RISK_PROFILE;

CREATE TABLE ${cur_schema}.TEMP_DIM_RISK_PROFILE (
...
/* ==============[Group.1]============== */
INSERT INTO ${cur_schema}.TEMP_DIM_RISK_PROFILE (
  CUSTOMER_ID, /* None */
...
SELECT
  ...
  '${batch_timestamp}' AS ETL_TIMESTAMP, /* None */
...
FROM ${com_schema}.M_KDI_CLIENTREPORT AS T1
