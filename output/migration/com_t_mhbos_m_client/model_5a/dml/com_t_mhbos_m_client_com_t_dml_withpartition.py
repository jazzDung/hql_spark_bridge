...
spark.sql(f"""
    ...
    ON com_t.<<partition_column>> = impacted_partitions.<<partition_column>>    WHERE com_t.raw_incremental_etl_dt != '{batch_date}'
""")
