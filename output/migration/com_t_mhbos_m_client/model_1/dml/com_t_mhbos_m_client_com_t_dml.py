...
spark.sql(f"""DROP TABLE IF EXISTS {params["com_schema"]}.temp_t_mhbos_m_client_final""")
spark.sql(f"""
    CREATE TABLE {params["com_schema"]}.temp_t_mhbos_m_client_final (
        client_no VARCHAR(9)
        , clean_rule_flag VARCHAR(60)
        , primary_identification_type VARCHAR(10)
        , primary_identification_no VARCHAR(60)
...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_t_mhbos_m_client_final
    SELECT
        r.client_no
        , r.clean_rule_flag
...
spark.sql(f"""
    ...
    SELECT
        ...
        , current_timestamp()  AS etl_timestamp
    FROM {params["com_schema"]}.temp_t_mhbos_m_client_final
""")
