...
# The main_processing_sqls for Model 2A is expected to read from raw_schema and perform transformations
...
spark.sql(f"""
    ...
    SELECT
        ...
        , current_timestamp() AS etl_timestamp
    FROM {params["com_schema"]}.temp_t_mhbos_m_client_consolidated t
""")
