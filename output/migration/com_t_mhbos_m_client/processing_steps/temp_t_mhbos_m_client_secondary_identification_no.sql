...
TRUNCATE TABLE   ${com_schema}.temp_t_mhbos_m_client_secondary_identification_no /* 2.1.1 ddl-insert-sundexin */;

INSERT INTO ${com_schema}.temp_t_mhbos_m_client_secondary_identification_no
SELECT
  mmc.client_no,
  mmc.id_type,
  mmc.ic_no_new,
