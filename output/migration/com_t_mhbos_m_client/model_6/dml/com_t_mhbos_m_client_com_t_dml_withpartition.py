...
# ─── STEP 1: Keep unchanged records based on reference columns from IMPACTED PARTITIONS ───
spark.sql(f"""
    ...
    ON com_t.<<partition_column>> = impacted_partitions.<<partition_column>>    WHERE
        ...
        AND NOT EXISTS (
            ...
            WHERE r.client_no = com_t.client_no AND r.<<partition_column>> = com_t.<<partition_column>>        )
""")
