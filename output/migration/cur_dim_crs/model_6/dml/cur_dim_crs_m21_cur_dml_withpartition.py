...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_dim_crs_m21_delta
    SELECT
        com_t.customer_id,
    ...
    FROM {params["com_schema"]}.dim_crs_m21 com_t
    INNER JOIN (
        SELECT DISTINCT SOURCE_NAME,CUSTOMER_ID,CRS_COUNTRY,TAXPAYER_IDENTIFICATION_NO_1        FROM {params["com_schema"]}.dim_crs_m21
