...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_crs_sungl
...
,'SUNGL' AS source_key    FROM {params["com_schema"]}.temp_dim_crs_sungl_updated
""")
