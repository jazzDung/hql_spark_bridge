...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_crs_sbl
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_crs_sbl
...
,'SBL' AS source_key    FROM {params["com_schema"]}.temp_dim_crs_sbl_updated
""")
