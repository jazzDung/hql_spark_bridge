...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_crs_m21
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_crs_m21
...
,'M21' AS source_key    FROM {params["com_schema"]}.temp_dim_crs_m21_updated
""")
