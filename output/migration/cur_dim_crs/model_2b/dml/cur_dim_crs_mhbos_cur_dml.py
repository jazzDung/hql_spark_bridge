...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_crs_mhbos
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_crs_mhbos
...
,'MHBOS' AS source_key    FROM {params["com_schema"]}.temp_dim_crs_mhbos_updated
""")
