...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_crs_guava
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_crs_guava
...
,'GUAVA' AS source_key    FROM {params["com_schema"]}.temp_dim_crs_guava_updated
""")
