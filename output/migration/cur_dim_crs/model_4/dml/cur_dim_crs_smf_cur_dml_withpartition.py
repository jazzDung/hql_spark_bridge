...
spark.sql(f"""
    INSERT INTO TABLE {params["cur_schema"]}.dim_crs_smf_h PARTITION (source_key, <<partition_column>>, hist_year)
    SELECT
        cur.customer_id,
        cur.crs_entity_type,
        cur.name_of_controlling_person_1,
        ...
        current_timestamp() AS etl_timestamp
, 'SMF' AS source_key        , cur.<<partition_column>>
