...
spark.sql(f"""
    ...
    FROM {params["com_schema"]}.temp_dim_address_sbl_delta delta
...
spark.sql(f"""
    INSERT INTO TABLE {params["cur_schema"]}.dim_address_sbl_h PARTITION (source_key, <<partition_column>>, hist_year)
    SELECT
        cur.owner_id,
        cur.address_owner_type,
        cur.address_type,
