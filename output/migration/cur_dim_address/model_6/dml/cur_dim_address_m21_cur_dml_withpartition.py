...
spark.sql(f"""
    INSERT INTO TABLE {params["com_schema"]}.temp_dim_address_m21_delta
    SELECT
        com_t.owner_id,
    ...
    FROM {params["com_schema"]}.dim_address_m21 com_t
    INNER JOIN (
        SELECT DISTINCT OWNER_ID,ADDRESS_OWNER_TYPE,ADDRESS_TYPE        FROM {params["com_schema"]}.dim_address_m21
