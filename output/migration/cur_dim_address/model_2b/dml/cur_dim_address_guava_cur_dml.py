...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_address_guava
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_address_guava
...
,'GUAVA' AS source_key    FROM {params["com_schema"]}.temp_dim_address_guava_updated
""")
