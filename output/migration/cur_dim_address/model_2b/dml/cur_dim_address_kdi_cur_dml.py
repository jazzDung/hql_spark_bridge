...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_address_kdi
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_address_kdi
...
,'KDI' AS source_key    FROM {params["com_schema"]}.temp_dim_address_kdi_updated
""")
