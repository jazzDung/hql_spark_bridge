...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_address_mhbos
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_address_mhbos
...
,'MHBOS' AS source_key    FROM {params["com_schema"]}.temp_dim_address_mhbos_updated
""")
