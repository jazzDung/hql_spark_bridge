...
spark.sql(f"""
    ...
    FROM {params["cur_schema"]}.dim_address_m21
...
""")
spark.sql(f"""
    INSERT OVERWRITE TABLE {params["cur_schema"]}.dim_address_m21
...
,'M21' AS source_key    FROM {params["com_schema"]}.temp_dim_address_m21_updated
""")
