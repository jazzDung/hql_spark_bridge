...
# ─── TEMP TABLE SETUP ────────────────────────────────────────────────────────
spark.sql(f"""DROP TABLE IF EXISTS {params["cur_schema"]}.temp_dim_customer_employment_mhbos_consolidated""")

spark.sql(f"""
CREATE TABLE {params["cur_schema"]}.temp_dim_customer_employment_mhbos_consolidated (
    customer_id VARCHAR(20)
    , customer_employer_name VARCHAR(100)
    , customer_employer_industry VARCHAR(100)
    , customer_employer_type VARCHAR(100)
    , customer_amla_occupation VARCHAR(100)
...
# ─── TEMP TABLE SETUP ────────────────────────────────────────────────────────
spark.sql(f"""DROP TABLE IF EXISTS {params["cur_schema"]}.temp_dim_customer_employment_mhbos_updated""")

spark.sql(f"""
CREATE TABLE {params["cur_schema"]}.temp_dim_customer_employment_mhbos_updated (
    customer_id VARCHAR(20)
    , customer_employer_name VARCHAR(100)
    , customer_employer_industry VARCHAR(100)
    , customer_employer_type VARCHAR(100)
...
spark.sql(f"""
INSERT INTO TABLE {params["cur_schema"]}.temp_dim_customer_employment_mhbos_updated
SELECT
    customer_id
...
SELECT
    ...
    , current_timestamp()  AS etl_timestamp
FROM {params["cur_schema"]}.temp_dim_customer_employment_mhbos_updated
""")
