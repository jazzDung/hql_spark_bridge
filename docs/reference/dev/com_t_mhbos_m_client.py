...
SELECT
  ...
  (
    CASE
      ...
      THEN TO_TIMESTAMP(SUBSTRING(id.primary_identification_no, 1, 6), 'yyMMdd')
...
WHERE NOT EXISTS (
    SELECT 1 FROM {params["com_schema"]}.temp_t_mhbos_m_client r
...
FROM {params["com_schema"]}.temp_t_mhbos_m_client r
