...
# COM_R
com_r_mhbos_m_client_ext = BashOperator(
    task_id='com_r_mhbos_m_client_ext',
    bash_command="""
        set -euo pipefail
        {{ var.value.spark_submit_config_low }} \
        {{ var.value.script_home_com }}/com_r_mhbos_m_client_ext.py
        """,
    dag=dag,
)

# COM_T
com_t_mhbos_m_client_ext = BashOperator(
    task_id='com_t_mhbos_m_client_ext',
    bash_command="""
        set -euo pipefail
        {{ var.value.spark_submit_config_low }} \
        {{ var.value.script_home_com }}/com_t_mhbos_m_client_ext.py
        """,
    dag=dag,
)
...
etl_run_start >> raw_mhbos_m_client_ext >> com_r_mhbos_m_client_ext >> com_t_mhbos_m_client_ext >> finish >> etl_run_end
