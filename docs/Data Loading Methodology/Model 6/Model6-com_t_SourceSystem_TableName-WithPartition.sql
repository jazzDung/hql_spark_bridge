...
--    File Type		: DML
--    Purpose       : [Model 6] Insert overwrite impacted partition(s) by delete and re-insert updated records based on reference column(s). 
...
WHERE NOT EXISTS -- get unchanged records based on reference column(s) and partition column(s)
