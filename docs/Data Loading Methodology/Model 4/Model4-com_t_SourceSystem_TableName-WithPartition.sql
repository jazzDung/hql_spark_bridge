...
--    File Type		: DML
--    Purpose       : [Model 4] Insert overwrite impacted partition(s) by delete and re-insert updated records based on key column(s). 
...
WHERE NOT EXISTS -- get unchanged records based on key column(s) and partition column(s)
...
/************** this is section to write all transformation logic for data from COM_R ***************/
...
SELECT 
    ...
    , r.<data_partition_column1>
    , r.<data_partition_column2>
