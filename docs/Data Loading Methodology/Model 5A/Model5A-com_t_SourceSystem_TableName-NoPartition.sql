...
--    File Type		: DML
--    Purpose       : [Model 5A] Append/insert only data to table. 
...
INSERT INTO TABLE ${com_schema}.t_<sourcesystem_tablename>
SELECT 
    <column1>
	, <datecolumn2>
	, <column3>	
    ...
    , <transformed_col1>
    , <transformed_col2>
    , raw_incremental_etl_dt --to store the etl_dt from RAW layer to know which etl_dt the incremental data loaded to COM_T. This is to avoid duplicate data being loaded for same day
    , record_status 
    , record_created_date 
    , record_updated_date 
