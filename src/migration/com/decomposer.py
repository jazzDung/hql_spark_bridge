...
class ComSqlDecomposer:
    def __init__(self, source_rules: dict):
        self.source_rules = source_rules

    def decompose(self, sql_file: Path) -> ComDecomposedScript:
        """
    ...
    def _build_temp_table_objects(self, temp_blocks: dict[str, list[exp.Expression]], original_content: str) -> list[ComTempTableBlock]:
        """
...
class ComDecomposerWriter:
    def write(self, decomposed: ComDecomposedScript, output_root: Path):
