...
class CurKeyDetector:
    def __init__(self):
        pass

    def detect(self, decomposed: CurDecomposedScript, source_rules: dict) -> dict:
        """
    ...
    def _get_all_statements(self, decomposed: CurDecomposedScript) -> list:
        try:
        ...
        for source_id, block in reversed(decomposed.source_blocks.items()):
            stmts.extend(block.ast_nodes)
        return stmts

    def _get_schema(self, decomposed: CurDecomposedScript, source_rules: dict) -> list[str]:
    ...
    def _detect_from_window_function(self, decomposed: CurDecomposedScript, source_rules: dict) -> Optional[dict]:
        """
