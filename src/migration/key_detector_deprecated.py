...
#
#     def detect(self, decomposed: ComDecomposedScript, columns: list, source_rules: dict) -> str:
#         strategies = [
...
#         return None
#
#     def _detect_from_join_analysis(self, decomposed: ComDecomposedScript) -> Optional[str]:
#         """
...
#         return None
#
#     def _detect_from_where_null_check(self, decomposed: ComDecomposedScript) -> Optional[str]:
#         for block in decomposed.temp_tables:
