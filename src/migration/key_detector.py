...
class KeyDetector:
    ...
    def detect(self, decomposed: DecomposedScript, source_rules: dict) -> dict:
        """
    ...
    def _get_all_statements(self, decomposed: DecomposedScript) -> list:
        try:
    ...
    def _get_schema(self, decomposed: DecomposedScript, source_rules: dict) -> list[str]:
    ...
    def _detect_from_window_function(self, decomposed: DecomposedScript, source_rules: dict) -> Optional[dict]:
        """
    ...
    def _detect_from_ddl(self, decomposed: DecomposedScript) -> Optional[dict]:
        """
    ...
    def _detect_from_join(self, decomposed: DecomposedScript) -> Optional[dict]:
        """
    ...
    def _detect_from_source_rule(self, decomposed: DecomposedScript, source_rules: dict) -> Optional[dict]:
